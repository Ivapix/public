...
<div class="u-columns col2-set" id="customer_login">
    ...
    <a class="back-to-site" href="/">Nazad na sajt</a>
<?php endif; ?>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
            ...
            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<input type="hidden" id="is-business-personal" class="woocommerce-Input woocommerce-Input--text input-text" name="is-business-personal"  Dvalue="<?php echo ( ! empty( $_POST['is-business-personal'] ) ) ? esc_attr( wp_unslash( $_POST['is-business-personal'] ) ) : ''; ?>" />
			</p>
